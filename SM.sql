...
CONNECTING_ANSWER CHAR(1) DEFAULT 'N' NOT NULL,
...
REALESTATE_ID NUMBER(5) NOT NULL,
...
NOCACHE
NOCYCLE;
CREATE OR REPLACE TRIGGER LIKELIST_TRIGGER
BEFORE INSERT ON LIKELIST
FOR EACH ROW
BEGIN
    SELECT LIKELIST_SEQ.NEXTVAL
    INTO:NEW.LIKE_ID
    FROM DUAL;
    END;
